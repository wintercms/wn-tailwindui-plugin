    ...
    <div class="rounded-md shadow-sm -space-y-px">
        <div>
            ...
            <div class="relative">
                ...
                <span class="group absolute right-0 inset-y-0 flex items-center pr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-neutral-500 group-focus:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <span class="group absolute right-0 inset-y-0 flex items-center pr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-neutral-500 group-focus:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
