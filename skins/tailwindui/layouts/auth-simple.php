<!DOCTYPE html>
<html lang="<?= App::getLocale() ?>" class="no-js h-full bg-neutral-50" data-color-scheme="<?= e(\Backend\Models\Preference::instance()->get('dark_mode', 'light')); ?>">
    <head>
    ...
    <body class="<?= $this->bodyClass ?> font-sans m-0 h-full bg-cover bg-no-repeat bg-center" style="background-image: url('<?= e(config('brand.backgroundImage')); ?>');">
        <div class="min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="mx-auto sm:w-full sm:max-w-md sm:max-w-sm">
                ...
                <h2 class="mt-6 text-2xl text-center font-medium text-neutral-900"><?= e(Backend\Models\BrandSetting::get('app_tagline')); ?></h2>
            </div>
