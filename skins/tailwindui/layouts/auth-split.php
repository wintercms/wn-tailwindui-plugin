...
<html lang="<?= App::getLocale() ?>" class="no-js" data-color-scheme="<?= e(\Backend\Models\Preference::instance()->get('dark_mode', 'light')); ?>">
    ...
    <body class="outer <?= $this->bodyClass ?> font-sans m-0">
        <div class="min-h-screen bg-white dark:bg-neutral-800 flex">
            <div class="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
                <div class="mx-auto w-full max-w-sm lg:w-96">
                    <div>
                        ...
                        <h2 class="mt-6 text-2xl text-center font-extrabold text-neutral-900 dark:text-neutral-300"><?= e(Backend\Models\BrandSetting::get('app_tagline')); ?></h2>
                    </div>
